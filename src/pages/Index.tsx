            ...
            <div className="w-full max-w-4xl mx-auto mt-12 space-y-4">
              ...
              <div className="relative max-w-3xl mx-auto">
                <input
                  ...
                  className="w-11/12 bg-[hsl(var(--cli-bg-secondary))] border border-terminal-pink px-4 py-3 text-terminal-white font-mono text-sm placeholder:text-terminal-gray focus:outline-none focus:ring-2 focus:ring-terminal-pink focus:border-transparent animate-fade-in"
                  onKeyDown={(e) => {
                    if (e.key === 'Enter') {
