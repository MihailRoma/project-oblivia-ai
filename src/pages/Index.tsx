            ...
            <div className="w-full max-w-4xl mx-auto mt-12 space-y-4">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-[hsl(var(--cli-bg-secondary))] border border-terminal-pink px-4 py-3 text-terminal-white font-mono text-sm placeholder:text-terminal-gray focus:outline-none focus:ring-2 focus:ring-terminal-pink focus:border-transparent animate-fade-in"
                  onKeyDown={(e) => {
                    if (e.key === 'Enter') {
                ...
                />
                <div className="absolute inset-0 pointer-events-none border border-terminal-pink animate-pulse opacity-30"></div>
              </div>
